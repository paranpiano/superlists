...
class ListViewTest(TestCase):
    ...
    def test_uses_list_template(self):
        response = self.client.get('/lists/the-only-in-the-world/')
...
class NewListTest(TestCase):
    ...
    def test_redirects_after_POST(self):
        ...
        # self.assertEqual(response['location'], '/lists/the-only-in-the-world/')
        self.assertRedirects(response,'/lists/the-only-in-the-world/')
